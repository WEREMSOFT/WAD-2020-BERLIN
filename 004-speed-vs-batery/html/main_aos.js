...
var wasmBinaryFile = 'main_aos.wasm';
...
// {{PRE_LIBRARY}}
  ...
  var __main_thread_futex_wait_address=36384;function _emscripten_futex_wake(addr, count) {
  ...
  function __cleanup_thread(pthread_ptr) {
      ...
      if (pthread) {
        ...
        if (typeof SharedArrayBuffer === 'undefined') return []; // No multithreading support, no-op.
        var pthreadMainJs = "main_aos.worker.js";
