...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 36512,
    DYNAMIC_BASE = 5279392,
    DYNAMICTOP_PTR = 35552;
...
var wasmBinaryFile = 'main_cache_unfriendly.wasm';
...
var ASM_CONSTS = {
  16280: function() {throw 'Canceled!'},  
 16456: function() {postMessage({cmd : 'processQueuedMainThreadWork'})},  
 16507: function($0) {if (!ENVIRONMENT_IS_PTHREAD) { if (!PThread.pthreads[$0] || !PThread.pthreads[$0].worker) { return 0; } PThread.pthreads[$0].worker.postMessage({cmd : 'processThreadQueue'}); } else { postMessage({targetThread : $0, cmd : 'processThreadQueue'}); } return 1;},  
 16875: function() {return !!(Module['canvas'])},  
 16911: function() {noExitRuntime = true}
};
...
// {{PRE_LIBRARY}}
  ...
  var __main_thread_futex_wait_address=36496;function _emscripten_futex_wake(addr, count) {
  ...
  function __cleanup_thread(pthread_ptr) {
      ...
      if (pthread) {
        ...
        if (typeof SharedArrayBuffer === 'undefined') return []; // No multithreading support, no-op.
        var pthreadMainJs = "main_cache_unfriendly.worker.js";
