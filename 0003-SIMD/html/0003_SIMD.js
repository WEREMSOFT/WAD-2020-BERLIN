...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 11525952,
    DYNAMIC_BASE = 16768832,
    DYNAMICTOP_PTR = 11524992;
...
var wasmBinaryFile = '0003_SIMD.wasm';
...
var ASM_CONSTS = {
  1902: function() {postMessage({cmd : 'processQueuedMainThreadWork'})},  
 1953: function($0) {if (!ENVIRONMENT_IS_PTHREAD) { if (!PThread.pthreads[$0] || !PThread.pthreads[$0].worker) { return 0; } PThread.pthreads[$0].worker.postMessage({cmd : 'processThreadQueue'}); } else { postMessage({targetThread : $0, cmd : 'processThreadQueue'}); } return 1;},  
 2321: function() {return !!(Module['canvas'])},  
 2357: function() {noExitRuntime = true}
};
...
// STATICTOP = STATIC_BASE + 11524928;
...
// {{PRE_LIBRARY}}
  ...
  var __main_thread_futex_wait_address=11525936;function _emscripten_futex_wake(addr, count) {
  ...
  function __cleanup_thread(pthread_ptr) {
      ...
      if (pthread) {
        ...
        PThread.mainThreadBlock = 11525152;
        ...
        if (typeof SharedArrayBuffer === 'undefined') return []; // No multithreading support, no-op.
        var pthreadMainJs = "0003_SIMD.worker.js";
